  ...
  return (
    ...
    >
      ...
      <motion.div
        initial="hidden"
        whileInView="show"
        className="max-w-[1240px] m-auto my-12 md:mb-[120px] p-[10vw] w-[95vw] md:w-[90vw] lg:w-[80vw] border-[1px] border-orange-100 bg-white shadow-lg"
      >
        {/* Title */}
        <motion.h1
      ...
      >
        <div>
          ...
          <motion.ul initial="hidden" whileInView="show"  className="pl-8">
            <motion.li
